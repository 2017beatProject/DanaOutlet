...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<!-- bxSlider 광고판 삽입 -->
			<div class="col-sm-3" style="padding-right: 10px" id="bxImgForHeight">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-4" style="padding: 0px 5px 0px 5px;">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">게시판베스트</h3>
					</div>
					<div class="panel-body">
						<ul class="list-group">
							<c:forEach items="${bestNoneList}" var="bean">
								<li class="list-group-item">
									<!-- <div class="col-sm-3">
											<a href="../dpg/board/${bean.dpgNum}">
												${bean.dpgWriter }
											</a>
										</div> --> <a href="../dpg/board/${bean.dpgNum}"><c:set
